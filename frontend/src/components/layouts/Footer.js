    ...
    return (
        <footer className="border-top bg-white mt-5">
            <div className='footer'>
                ...
                <div className="text-white d-flex d-row justify-content-around align-items-center flex-wrap" style={{ backgroundColor: "#65617D" }}>
                    <div>
...
//https://web.facebook.com/nabia.sheikh.1997/
